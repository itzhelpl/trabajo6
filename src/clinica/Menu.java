...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        jMenuItem2.add(new JSeparator());
        jMenuItem3.add(new JSeparator());
        jMenuItem5.add(new JSeparator());
        jMenuItem6.add(new JSeparator());
    }
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Datos Medicos");
        ...
        jMenu2.setText("Panel de Control");
